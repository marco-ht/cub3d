...
SRC     = $(SRC_DIR)/main.c $(SRC_PARSE)/parsing.c $(SRC_PARSE)/parsefields.c $(SRC_PARSE)/scene_check.c $(SRC_PARSE)/scene_check_2.c $(SRC_PARSE)/cases.c $(SRC_PARSE)/cases2.c $(SRC_PARSE)/parsemap.c $(SRC_PARSE)/checkmap.c $(SRC_PARSE)/checkmap_2.c $(SRC_PARSE)/sqrmap.c $(SRC_REND)/rendering.c $(SRC_REND)/init_player.c $(SRC_REND)/rendering_loop.c $(SRC_REND)/rendering_texture.c $(SRC_REND)/rendering_pixel.c $(SRC_REND)/rendering_utils.c $(SRC_REND)/rendering_utils2.c $(SRC_REND)/fps.c $(SRC_REND)/move_player.c $(SRC_REND)/debug_mode.c $(SRC_RAY)/raycasting.c $(SRC_UTLS)/utils.c $(SRC_UTLS)/utils2.c $(SRC_GNL)/get_next_line_utils.c $(SRC_GNL)/get_next_line.c
OBJ     = $(OBJ_DIR)/main.o $(OBJ_DIR)/parsing.o $(OBJ_DIR)/parsefields.o $(OBJ_DIR)/scene_check.o $(OBJ_DIR)/scene_check_2.o $(OBJ_DIR)/cases.o $(OBJ_DIR)/cases2.o $(OBJ_DIR)/parsemap.o $(OBJ_DIR)/checkmap.o $(OBJ_DIR)/checkmap_2.o $(OBJ_DIR)/sqrmap.o $(OBJ_DIR)/rendering.o $(OBJ_DIR)/init_player.o $(OBJ_DIR)/rendering_loop.o $(OBJ_DIR)/rendering_texture.o $(OBJ_DIR)/rendering_pixel.o $(OBJ_DIR)/rendering_utils.o $(OBJ_DIR)/rendering_utils2.o $(OBJ_DIR)/fps.o $(OBJ_DIR)/move_player.o $(OBJ_DIR)/debug_mode.o $(OBJ_DIR)/raycasting.o $(OBJ_DIR)/utils.o $(OBJ_DIR)/utils2.o $(OBJ_DIR)/get_next_line_utils.o $(OBJ_DIR)/get_next_line.o
SRCB     = $(SRCB_DIR)/main_bonus.c $(SRCB_PARSE)/parsing_bonus.c $(SRCB_PARSE)/parsefields_bonus.c $(SRCB_PARSE)/scene_check_bonus.c $(SRCB_PARSE)/scene_check_2_bonus.c $(SRCB_PARSE)/cases_bonus.c $(SRCB_PARSE)/cases2_bonus.c $(SRCB_PARSE)/parsemap_bonus.c $(SRCB_PARSE)/checkmap_bonus.c $(SRCB_PARSE)/checkmap_bonus_2.c $(SRCB_PARSE)/sqrmap_bonus.c $(SRCB_REND)/rendering_bonus.c $(SRCB_REND)/init_player_bonus.c $(SRCB_REND)/rendering_loop_bonus.c $(SRCB_REND)/rendering_texture_bonus.c $(SRCB_REND)/rendering_pixel_bonus.c $(SRCB_REND)/rendering_utils_bonus.c $(SRCB_REND)/rendering_utils2_bonus.c $(SRCB_REND)/fps_bonus.c $(SRCB_REND)/move_player_bonus.c $(SRCB_REND)/render_map_bonus.c $(SRCB_REND)/debug_mode_bonus.c $(SRCB_REND)/doors_mouse_bonus.c $(SRCB_REND)/doors_mouse_bonus_utils.c $(SRCB_REND)/sprite_bonus.c $(SRCB_RAY)/raycasting_bonus.c $(SRCB_UTLS)/utils_bonus.c $(SRCB_UTLS)/utils2_bonus.c $(SRCB_GNL)/get_next_line_utils.c $(SRCB_GNL)/get_next_line.c
OBJB     = $(OBJ_DIR)/main_bonus.o $(OBJ_DIR)/parsing_bonus.o $(OBJ_DIR)/parsefields_bonus.o $(OBJ_DIR)/scene_check_bonus.o $(OBJ_DIR)/scene_check_2_bonus.o $(OBJ_DIR)/cases_bonus.o $(OBJ_DIR)/cases2_bonus.o $(OBJ_DIR)/parsemap_bonus.o $(OBJ_DIR)/checkmap_bonus.o $(OBJ_DIR)/checkmap_bonus_2.o $(OBJ_DIR)/sqrmap_bonus.o $(OBJ_DIR)/rendering_bonus.o $(OBJ_DIR)/init_player_bonus.o $(OBJ_DIR)/rendering_loop_bonus.o $(OBJ_DIR)/rendering_texture_bonus.o $(OBJ_DIR)/rendering_pixel_bonus.o $(OBJ_DIR)/rendering_utils_bonus.o $(OBJ_DIR)/rendering_utils2_bonus.o $(OBJ_DIR)/fps_bonus.o $(OBJ_DIR)/move_player_bonus.o $(OBJ_DIR)/debug_mode_bonus.o $(OBJ_DIR)/render_map_bonus.o $(OBJ_DIR)/doors_mouse_bonus.o $(OBJ_DIR)/doors_mouse_bonus_utils.o $(OBJ_DIR)/sprite_bonus.o $(OBJ_DIR)/raycasting_bonus.o $(OBJ_DIR)/utils_bonus.o $(OBJ_DIR)/utils2_bonus.o $(OBJ_DIR)/get_next_line_utils.o $(OBJ_DIR)/get_next_line.o
